...
export default class {
  ...
  render() {
    this.data.map(info => {
      if (info.dataID === this.ID) {
        info.個票.map((eachDataInfo, eachDataIndex) => {
          ...
          <div class="company-detail-heading">
            <h4 class="heading04">加盟店向けサービス${eachDataIndex === 0 ? '①' : eachDataIndex === 1 ? '②' : eachDataIndex === 2 ? '③' : eachDataIndex === 3 ? '④' : eachDataIndex === 4 ? '⑤' : ''}</h4>
          ...
          <div class="grid-container">
            ...
            <table class="detail-table table-third">
              ...
              <tr class="table-data-wrapper">
                ...
                <td class="table-data">${eachDataInfo.月次一括の場合の締日}</td>
              </tr>
              <tr class="table-data-wrapper">
                <th class="table-secondary-heading">支払日</th>
                <td class="table-data">${eachDataInfo.月次一括の場合の支払日}</td>
              </tr>
              <tr class="table-data-wrapper">
            ...
            <table class="detail-table table-fourth">
              ...
              <tr class="table-data-wrapper">
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間中.費目1 === '' || eachDataInfo.発生する費用.期間中.費目1 === 'なし' ?  '' : eachDataInfo.発生する費用.期間中.費目1}${eachDataInfo.発生する費用.期間中.費目1 === '' || eachDataInfo.発生する費用.期間中.費目1 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間中.金額1}${eachDataInfo.発生する費用.期間中.単位1}
                </td>
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間中.費目2 === '' || eachDataInfo.発生する費用.期間中.費目2 === 'なし' ?  '' : eachDataInfo.発生する費用.期間中.費目2}${eachDataInfo.発生する費用.期間中.費目2 === '' || eachDataInfo.発生する費用.期間中.費目2 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間中.金額2}${eachDataInfo.発生する費用.期間中.単位2}
                </td>
              </tr>
              <tr class="table-data-wrapper">
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間中.費目3 === '' || eachDataInfo.発生する費用.期間中.費目3 === 'なし' ?  '' : eachDataInfo.発生する費用.期間中.費目3}${eachDataInfo.発生する費用.期間中.費目3 === '' || eachDataInfo.発生する費用.期間中.費目3 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間中.金額3}${eachDataInfo.発生する費用.期間中.単位3}
                </td>
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間中.費目4 === '' || eachDataInfo.発生する費用.期間中.費目4 === 'なし' ?  '' : eachDataInfo.発生する費用.期間中.費目4}${eachDataInfo.発生する費用.期間中.費目4 === '' || eachDataInfo.発生する費用.期間中.費目4 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間中.金額4}${eachDataInfo.発生する費用.期間中.単位4}
                </td>
              </tr>
            </table>
            ...
            <table class="detail-table table-fifth">
              ...
              <tr class="table-data-wrapper">
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間終了後.費目1 === '' || eachDataInfo.発生する費用.期間終了後.費目1 === 'なし' ?  '' : eachDataInfo.発生する費用.期間終了後.費目1}${eachDataInfo.発生する費用.期間終了後.費目1 === '' || eachDataInfo.発生する費用.期間終了後.費目1 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間終了後.金額1}${eachDataInfo.発生する費用.期間終了後.単位1}
                </td>
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間終了後.費目2 === '' || eachDataInfo.発生する費用.期間終了後.費目2 === 'なし' ?  '' : eachDataInfo.発生する費用.期間終了後.費目2}${eachDataInfo.発生する費用.期間終了後.費目2 === '' || eachDataInfo.発生する費用.期間終了後.費目2 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間終了後.金額2}${eachDataInfo.発生する費用.期間終了後.単位2}
                </td>
              </tr>
              <tr class="table-data-wrapper">
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間終了後.費目3 === '' || eachDataInfo.発生する費用.期間終了後.費目3 === 'なし' ?  '' : eachDataInfo.発生する費用.期間終了後.費目3}${eachDataInfo.発生する費用.期間終了後.費目3 === '' || eachDataInfo.発生する費用.期間終了後.費目3 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間終了後.金額3}${eachDataInfo.発生する費用.期間終了後.単位3}
                </td>
                <td class="table-data data-period-cost">
                  ${eachDataInfo.発生する費用.期間終了後.費目4 === '' || eachDataInfo.発生する費用.期間終了後.費目4 === 'なし' ?  '' : eachDataInfo.発生する費用.期間終了後.費目4}${eachDataInfo.発生する費用.期間終了後.費目4 === '' || eachDataInfo.発生する費用.期間終了後.費目4 === 'なし' ? '' : '：'}${eachDataInfo.発生する費用.期間終了後.金額4}${eachDataInfo.発生する費用.期間終了後.単位4}
                </td>
              </tr>
            </table>
          ...
          info.対応可能な決済端末.map(terminalDetailInfo => {
            ...
            <dt class="each-payment-terminal-heading fn-button-each-payment-terminal-heading">
              <span class="each-payment-terminal-image-wrapper">
                ${terminalDetailInfo.画像ファイル名 === '' ? '' : `<img src="/assets/img/${terminalDetailInfo.画像ファイル名}" class="each-payment-terminal-image"/>` }
              </span>
            ...
            <dd class="each-payment-terminal-detail fn-each-payment-terminal-detail">
              ...
              <table class="payment-terminal-table">
                ...
                <tr class="payment-terminal-table-list">
                  ...
                  ${terminalDetailInfo.有線LAN ? 'モバイル通信（4G,LTE等）<br>' : ''}
  ...
  paymentTerminalAnchorLink() {
    ...
    if (this.selectors.componentsPaymentTerminalAnchorLinkButton && paymentTerminalContents) {
      ...
      this.selectors.paymentTerminalAnchorLinkButton.addEventListener('click', event => {
